...
import { 
  ...
  ActivityIndicator, FlatList, Linking, TouchableOpacity, Alert 
} from 'react-native';
...
export default function PatientDashboardScreen() {
  ...
  const healthSchemes = [
    { 
      ...
      description: 'Medical coverage up to ₹5L/year.', 
      color1: '#00796B', color2: '#004D40', 
      icon: 'hospital-building',
      url: 'https://pmjay.gov.in'
    },
    { 
      title: 'PM Jan Arogya', 
      description: 'Insurance for vulnerable citizens.', 
      color1: '#26A69A', color2: '#00897B', 
      icon: 'account-heart',
      url: 'https://www.google.com/search?q=PM+Jan+Arogya+scheme'
    },
    { 
      title: 'State Health Programs', 
      description: 'Check state portal for benefits.', 
      color1: '#4DB6AC', color2: '#00796B', 
      icon: 'file-document-outline',
      url: 'https://www.google.com/search?q=State+Health+Programs+India'
    },
  ];
  ...
  const moreSchemes = [
    {
      ...
      description: "Financial aid for pregnant women and mothers.",
      color1: "#009688", color2: "#004D40",
      icon: "baby-carriage",
      url: "https://wcd.nic.in/schemes/pradhan-mantri-matru-vandana-yojana"
    },
    {
      title: "Janani Suraksha Yojana",
      description: "Safe motherhood cash assistance for institutional delivery.",
      color1: "#4DB6AC", color2: "#00796B",
      icon: "human-pregnant",
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.profileCard}>
          ...
          <View style={{ marginLeft: 20, flex: 1 }}>
            ...
            {migrantType && (
              <Text style={styles.profileInfo}>Migrant Type: {migrantType}</Text>
            )}
...
const styles = StyleSheet.create({
  ...
  profileCard: { flexDirection: 'row', backgroundColor: '#E0F2F1', borderRadius: 20, padding: 20, marginBottom: 25, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 5, elevation: 4 },
  profileName: { fontSize: 20, fontWeight: 'bold', color: '#004D40' },
  profileInfo: { fontSize: 14, color: '#00796B', marginTop: 3 },
